...
LocalScribe is a local web application that transcribes your meetings securely, right within your browser. By utilizing the browser's built-in speech recognition, it ensures your data remains completely private. Absolutely no installation required.

## ✨ Features

- **🛡️ 100% Private & Corporate Safe:** All transcription happens locally in your browser.
